  ...
  <div class="font-montserrat">
    ...
    <div v-else-if="asesorado" class="pb-10">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <!-- 1. DATOS PERSONALES -->
        <div class="bg-[#171717] p-6 rounded-xl shadow-xl border border-[#3B3B3B] border-t-4 border-t-[#202A78] lg:col-span-2">
        ...
        <div v-if="asesorado.sexo === 'Mujer'" class="bg-[#171717] p-6 rounded-xl shadow-xl border border-[#3B3B3B] border-t-4 border-t-[#202A78]">
          <h3 class="text-[#D4D4D4] font-black uppercase tracking-widest text-sm flex items-center gap-2 mb-6 border-b border-[#3B3B3B] pb-3">
        ...
        <!-- 3. HISTORIAL MÉDICO -->
        <div class="bg-[#171717] p-6 rounded-xl shadow-xl border border-[#3B3B3B] border-t-4 border-t-[#202A78]" :class="{ 'lg:col-span-2': asesorado.sexo !== 'Mujer' }">
          <h3 class="text-[#D4D4D4] font-black uppercase tracking-widest text-sm flex items-center gap-2 mb-6 border-b border-[#3B3B3B] pb-3">
        ...
        <!-- 4. PERFIL DEPORTIVO -->
        <div class="bg-[#171717] p-6 rounded-xl shadow-xl border border-[#3B3B3B] border-t-4 border-t-[#202A78]">
          <h3 class="text-[#D4D4D4] font-black uppercase tracking-widest text-sm flex items-center gap-2 mb-6 border-b border-[#3B3B3B] pb-3">
