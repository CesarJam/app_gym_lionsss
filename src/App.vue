...
const updateCarousel = () => {
    const percentage = -currentSlide.value * 100
    carouselStyle.value = `transform: translateX(${percentage}%)`
}
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="cta-container">
                <a href="/admin/login" class="btn btn-primary">GESTIONAR GIMNASIO</a>
...
<style>
/* Aquí pegamos tu CSS exacto para mantener el diseño idéntico */
:root {
    --primary-blue: #2563eb;
    --dark-bg: #0f172a;
    --text-white: #f8fafc;
...
@media (max-width: 768px) {
    ...
    .nav-buttons a { margin: 0; width: 100%; text-align: center; display: block; padding: 15px; font-size: 1.1rem; }
    .navbar { flex-direction: column; gap: 15px; padding: 10px; }
    .hero { height: 600px; }
